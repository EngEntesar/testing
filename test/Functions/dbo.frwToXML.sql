...
CREATE FUNCTION [dbo].[frwToXML]
(
/*this function converts a frwJSONHierarchy table into an XML document. This uses the same technique as the frwToJSON function, and uses the 'entities' form of XML syntax to give a compact rendering of the structure */
